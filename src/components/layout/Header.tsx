    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <nav className="hidden items-center gap-6 md:flex">
          <Link href="/products" className="text-sm font-medium text-slate-600 hover:text-[#0c2340]">
            Products
          </Link>
          <Link href="/pricing" className="text-sm font-medium text-slate-600 hover:text-[#0c2340]">
            Pricing
          </Link>
          <Link href="/compare" className="text-sm font-medium text-slate-600 hover:text-[#0c2340]">
            Compare
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-3">
          {session ? (
            ...
            <>
              <Link href="/login" className="text-sm font-medium text-slate-600 hover:text-[#0c2340]">
                Sign In
              </Link>
              <Link
                href="/signup"
