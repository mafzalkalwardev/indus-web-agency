          ...
          {loading ? (
            ...
            <>
              <Link
                ...
                className="hidden rounded-lg bg-cyan-500 px-4 py-2 text-sm font-semibold text-white shadow-md shadow-cyan-900/30 transition hover:bg-cyan-400 sm:inline-flex sm:items-center sm:gap-1.5"
              >
                Start Project
              </Link>
              <Link
        ...
        <nav className="border-t border-white/10 px-4 py-3 lg:hidden">
          <div className="flex flex-col gap-1">
            ...
            {user ? (
              ...
              <>
                <Link href={href("/start-project")} onClick={() => setMobileNav(false)} className="rounded-lg bg-cyan-500 px-3 py-2.5 text-center text-sm font-semibold text-white">Start Project</Link>
